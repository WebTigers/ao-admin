...
let $portfolioAjaxItems			= jQuery('.portfolio-ajax').find('.portfolio-item'),
	$portfolioDetails			= jQuery('#portfolio-ajax-wrap'),
	$portfolioDetailsContainer	= jQuery('#portfolio-ajax-container'),
	$portfolioAjaxLoader		= jQuery('#portfolio-ajax-loader'),
	prevPostPortId				= '';
